...
def scanner_loop():
    """
    Continuous Scanner.
    Scans ALL timeframes independently for all symbols.
    """
                ...
                if dfs:
                    ...
                    for tf in timeframes:
                        ...
                        if master:
                            ...
                            if s['status'] == "ACTIVE": current_exp += 1

                            # Only show VALID signals (ACTIVE)
                            if s['status'] == "ACTIVE":
                                results.append({
                                    "symbol": sym,
                                    "exchange": active_ex,
...
<head>
    ...
    <style>
        ...
        th { text-align: left; border-bottom: 1px solid #333; padding: 4px; color: #00ff00; font-weight: bold; }
        ...
        .long { color: #00ff00; }
        .short { color: #ff0000; }
        .mega { color: #d4af37; font-weight: bold; } /* Gold/Purple for MEGA */
    ...
    <script>
        ...
        function render(data) {
            ...
            if (data.signals.length === 0) {
                grid.innerHTML = '<div class="empty-msg">NO EXPLOSIVE RELEASE DETECTED (WAITING FOR 0.1% SQZ)</div>';
            } else {
                ...
                data.signals.forEach(s => {
                    ...
                    let sqzColor = '#fff';
                    if(isMega) sqzColor = '#d4af37'; // Gold/Purple for MEGA
